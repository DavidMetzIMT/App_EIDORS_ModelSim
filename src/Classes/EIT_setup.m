classdef EIT_setup < handle
    ...
    methods
        ...
        function [shape, elec_pos, elec_shape, elec_obj, z_contact, elec_pos_2d, error] = data_for_ng(obj)
            ...
            elec_obj= {};
            for i=1:length(obj.elec_layout)
                [elec_pos_i, elec_shape_i, elec_obj_i, z_contact_i, elec_pos_2d_i, error] = obj.elec_layout(i).data_for_ng(obj.chamber);
                if error.code
                    return;
                end
