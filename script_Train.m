...
proto_fid=fopen([out_path '\' 'Train_protocol' char(t) '.txt'],'w');
...
user_entry.num_trainingData = 500;                  % the number of sets for generating training data
...
if notCancelled
    ...
    % if cancelled than
    % rng(12323) to get all teh time same random generation...
