classdef EITDataset
    ...
    methods ( Access = public )
        ...
        function s_data=get_single_data(obj,idx)
            ...
            obj=obj.change_actual_folder('get_back_old_folder');
        end
        ...
        function obj = generate_eit_dataset(obj, user_entry, out_path)
            ...
            tStart= tic;
            % save old Folder and move to the out_path
            obj.actual_path= out_path;
            obj=obj.change_actual_folder('goto_actual_path');
            % make output dir for Single_data and Samples
            
            mkdir([obj.single_data_folder]);
        ...
        function obj= generate_single_data(obj,size_file_single_data_max)
            ...
            for i=1:num_samples
                ...
                if (size_of_single_data == size_file_single_data_max) || (i==num_samples)
                    ...
                    save([obj.single_data_folder filesep obj.single_data_filenames{batch_idx}], 'single_data');
...
%                 stat_eval(:,i,:)= stat_evaltmp             
        ...
        function obj= save_eit_dataset(obj)
            eit_dataset = obj;
            save(obj.eit_dataset_filename, 'eit_dataset')
        end
        ...
        function make_mat_file4py(obj)
            ...
            pwd
            filename= [obj.user_entry.net_file_name '_infos2py.mat'];
